    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex">
              ...
              <h6 class="ms-md-3">Edit Tenant</h6>
            </div>
            <div class="card-body px-4 pt-4 pb-2">
                ...
                ?>
                <?php echo form_open_multipart('admin/Kategori/UpdateData/' . $detailkategori['id']) ?>
                ...
                <div class="form-group">
                    <img src="<?= base_url('Admin/assets/img/' . $detailkategori['foto'])?>" id="gambar_load" width="180px" height="200px"> 
                </div>
                </div>
            </div>
